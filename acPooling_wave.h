...
public:
    ...
    MHA_AC::waveform_t p_second_max;  // Second peak AC variable 
    mha_wave_t c;
    ...
    unsigned int second_max_ind;           // second peak indx 
    mha_real_t second_max_value;           // second peak value 
    unsigned int min_peak_separation;      // minimuum separation for second peak *************
...
public:
    ...
    MHAParser::string_t second_max_pool_ind_name;   // parser variable for second peak name
